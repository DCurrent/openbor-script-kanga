...
// Variable keys.
#define DC_KANGA_VAR_KEY_BASE_ID		"dckan"
#define DC_KANGA_VAR_KEY_INSTANCE			DC_KANGA_VAR_KEY_BASE_ID + 0
#define DC_KANGA_KEY_TARGET					DC_KANGA_VAR_KEY_BASE_ID + 1
#define DC_KANGA_VAR_KEY_DEBUG_FLAG			DC_KANGA_VAR_KEY_BASE_ID + 2
#define DC_KANGA_VAR_KEY_DEBUG_RGB_BLUE		DC_KANGA_VAR_KEY_BASE_ID + 3
#define DC_KANGA_VAR_KEY_DEBUG_RGB_GREEN	DC_KANGA_VAR_KEY_BASE_ID + 4
#define DC_KANGA_VAR_KEY_DEBUG_RGB_RED		DC_KANGA_VAR_KEY_BASE_ID + 5
#define DC_KANGA_VAR_KEY_DEBUG_TINT_MODE	DC_KANGA_VAR_KEY_BASE_ID + 6
#define DC_KANGA_VAR_KEY_TIME_INITIAL		DC_KANGA_VAR_KEY_BASE_ID + 7
